...
<header className="bg-blueGray-50 w-full top-0 ">
        <div className="max-auto  px-8 py-12 bg-blueGray-50">
         <div className="flex justify-between">
          ...
          <h1 className="text-black text-4xl font-bold">Lowest quote for services:<br/>$<span className="font-mono text-blue-700">5.95 </span></h1>
            </div>
      ...
      >
        ...
        >
          <div className="inline-block">
            <div
              className=" px-8 py-8 bg-white w-96 h-48 max-w-xs overflow-hidden rounded-lg shadow-md bg-white hover:shadow-xl transition-shadow duration-300 ease-in-out"
            >
            <img src="https://www.danslenuage.quebec/wp-content/uploads/sites/100/2020/01/aws.png" className="logo-area h-4"></img>
            ...
            <div
              className=" px-8 py-8 bg-white w-96 h-48 max-w-xs overflow-hidden rounded-lg shadow-md bg-white hover:shadow-xl transition-shadow duration-300 ease-in-out"
            >
            <img src="https://logos-world.net/wp-content/uploads/2021/05/Azure-Logo-700x394.png" className="logo-area h-4"></img>
